...
// tone-matched + pre-blur=1. NOT wired into the live component (see docs/FRAME-FIDELITY.md).
  ...
  render: (args: { frame: string }) => (
    <div style={{ display: 'grid', gap: 16, maxWidth: 820 }}>
      <p style={{ font: '11px/1.5 system-ui', color: '#aab4c0', margin: 0, maxWidth: 760 }}>
        ...
        cracked-stone-2 surface as the clean baseline (tone-matched, pre-blur=1), LaMa-free. Should match on

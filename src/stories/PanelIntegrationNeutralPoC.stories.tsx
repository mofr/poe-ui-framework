...
// PoC bg-baseline neutral maps — clean baseline = a traced reference region (op:"baseline"), tone-matched, solid (flat) baseline.
// LaMa dropped for panels. NOT wired into the live component (see docs/FRAME-FIDELITY.md).
  ...
  render: (args: { frame: string }) => (
    <div style={{ display: 'grid', gap: 16, maxWidth: 820 }}>
      <p style={{ font: '11px/1.5 system-ui', color: '#aab4c0', margin: 0, maxWidth: 760 }}>
        ...
        raster (now composited normal, live). <b>bg baseline</b> = neutral relight map whose clean baseline is
        sampled from a traced reference region (op:"baseline"), tone-matched, solid (flat), LaMa-free. Should match on
